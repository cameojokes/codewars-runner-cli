...
module.exports.run = function run(opts, cb) {
  shovel.start(opts, cb, {
    solutionOnly: function(runCode) {
      runCode({
        name: 'go',
        args: ['run', writeFileSync(`/home/${opts.codeUser}`, 'code.go', opts.solution, true)]
      });
    },
    ...
    testIntegration: function(runCode) {
      ...
      const dir = `/home/${opts.codeUser}/go/src/codewarrior/${pkgName}`;
      ...
      runCode({
        ...
        options: {
          ...
          env: Object.assign({}, process.env, {
            ...
            GOPATH: `${process.env.GOPATH}:/home/${opts.codeUser}/go`
          })
        }
      });
    },
