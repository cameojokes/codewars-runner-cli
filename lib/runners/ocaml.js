...
module.exports.run = function run(opts, cb) {
  shovel.start(opts, cb, {
    solutionOnly: function(runCode) {
      ...
      runCode({
        name: 'bash',
        args: [`/home/${opts.codeUser}/run_ocaml.sh`, 'utop', '-require', 'core', '-require', 'batteries', '-require', 'oUnit', '-stdin'],
        stdin: stdin
      });
    },
    testIntegration: function(runCode) {
      ...
      runCode({
        name: 'bash',
        args: [`/home/${codeuser}/run_ocaml.sh`, 'utop', '-require', 'core', '-require', 'batteries', '-require', 'oUnit', '-stdin'],
        stdin: stdin
      });
    }
  });
